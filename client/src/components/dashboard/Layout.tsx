  ...
  return (
    <div className="min-h-screen flex bg-(--bg)">
      ...
      <aside
        ...
        bg-[#0d1424] border-r border-white/6
      ...
      >
        ...
        {/* User info */}
        {user && (
          <div className="p-4 mx-3 mt-3 rounded-xl bg-white/3] border border-white/6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-linear-to-br from-brand-500 to-saffron-500 flex items-center justify-center text-white font-bold font-display text-sm">
          ...
          {navItems.map(({ icon: Icon, label, path }) => {
            ...
            return (
              ...
              >
                ...
                {label}
                {path === "/daily-review" && (
                  <span className="ml-auto bg-saffron-500/20 text-saffron-400 text-xs px-1.5 py-0.5 rounded-md font-semibold">
                    Daily
                  </span>
                )}
              </Link>
      ...
      <main className="flex-1 min-w-0">
        {/* Mobile topbar */}
        <div className="lg:hidden flex items-center gap-3 p-4 border-b border-white/6 sticky top-0 bg-(--bg) z-10">
          <button
